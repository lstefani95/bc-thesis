...
\begin{document}
	...
	\begin{table}[h]
		...
		\vskip\abovecaptionskip\emph{Zdroj: <<vlastné spracovanie>>}
		\vskip\abovecaptionskip\emph{Pozn.: V tabuľke sú uvedené odhady koeficientov logit modelu a v zátvorkách sa nachádzajú smerodatné chyby.}
