...
\thesissetup{
    ...
    abstract           = {Predmetom bakalárskej práce "Motivačný efekt priebežného výsledku: Robustnosť evidencie zo športových zápasov" je skúmať motivačný efekt tesnej prehry v priebehu hry na dátach z basketbalových zápasov. Úvodná časť práce je literárnou rešeršou odbornej literatúry súvisiacej s predmetom práce. Následne v práci overujeme robustnosť motivačného efektu bytia pozadu, skúmame prípadnú rozdielnosť medzi mužským a ženským basketbalom a testujeme možnosť, že je efekt ovplyvňovaný veľkosťou favorizovania tímu a to za pomoci regresnej diskontinuity.},
    ...
    keywordsEn         = {basketball, Berger and Pope, motivation effect, regression discontinuity design},
    TeXkeywordsEn      = {basketball, Berger and Pope, motivation effect, regression discontinuity design},
